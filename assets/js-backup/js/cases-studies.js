      ...
      if (mapping) {
        chartCardsHtml += `
          <div class="grc-4 m-anim-blur-fade">
            <div class="chart-card features-card m-anim-blur-fade ">
        ...
        chartCardsHtml += `
          <div class="grc-4 m-anim-blur-fade">
            <div class="chart-card features-card m-anim-blur-fade  centered">
              <div class="d-flex justify-content-between align-items-center mb-4">
                <h5 class="text-dark mb-0">${metricName}</h5>
  ...
  function renderRelatedSlider(allCases, currentSlug) {
      ...
      slidesHtml += `
        <div class="swiper-slide h-auto">
          <div class="features-card blog-section-5__item h-100 fl f-col p-3 ${activeClass}">
            <span class="pr px-2 py-3 w-auto" style="font-size: 14px; color: var(--primary); font-weight: 500;">
              2026 // ${cs.duration}
            </span>
    ...
    $el.html(`
      <section class="related-cases-slider-section py-5 my-5">
        <div class="fl " style="translate: none; rotate: none; scale: none; opacity: 1; transform: translate(0px, 0px);">
          <div class="text-center text-lg-start fl align-items-start f-col mb-40 w-100">
            <span class="section__subtitle d-none d-md-flex w-fit " data-wow-delay=".2s"><span></span>Success Stories</span>
            <div class="fl justify-content-between w-100">
              <h2 class="title text-right wow mt-4 mb-4 title" data-wow-delay="0.3s">Explore Other <r>Case Studies</r></h2>
