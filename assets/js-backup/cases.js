document.addEventListener("DOMContentLoaded", async function () {
  ...
  const [
    ...
    fetchPexelsImage(
      "real estate property modern building aerial",
      "assets/images/project/project-img-1.jpg",
    ),
    fetchPexelsImage(
      "mobile app technology smartphone ride sharing urban",
      "assets/images/project/project-img-1.jpg",
    ),
    fetchPexelsImage(
      "luxury jewellery gold diamond ring premium store",
      "assets/images/project/project-img-2.jpg",
    ),
    fetchPexelsImage(
      "food delivery restaurant meal packaging courier",
      "assets/images/project/project-img-2.jpg",
    ),
    fetchPexelsImage(
      "beauty skin clinic healthcare consultation doctor woman",
      "assets/images/project/project-img-3.jpg",
    ),
    fetchPexelsImage(
      "online education student learning classroom technology",
      "assets/images/project/project-img-3.jpg",
    ),
    fetchPexelsImage(
      "generative AI creative design digital art media",
      "assets/images/blog/blog.jpg",
    ),
    fetchPexelsImage(
      "artificial intelligence business technology future",
...
`,
 ...
 <div class="blog__inner">
        ...
        <div class="service-section__info mb-5">
            <h4 data-wow-delay="0.3s">Latest Insights: How AI is
...
function animateApproachSection() {
  ...
  const splitTitle = new SplitText(".split-text-anim", {
    type: "chars, words",
  });
